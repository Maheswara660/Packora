...
class AppUpdateManagerTest {
    ...
    fun testIsNewerVersion() {
        // Newer versions
        assertTrue(AppUpdateManager.isNewerVersion("4.1.0", "5.0.0"))
        assertTrue(AppUpdateManager.isNewerVersion("4.0.0", "5.0.0"))
        assertTrue(AppUpdateManager.isNewerVersion("4.0.0", "4.1.0"))
        assertTrue(AppUpdateManager.isNewerVersion("3.3.2", "4.1.0"))
        ...
        assertTrue(AppUpdateManager.isNewerVersion("3.2.3", "3.3.1"))
        assertTrue(AppUpdateManager.isNewerVersion("3.2.2", "3.3.0"))
        assertTrue(AppUpdateManager.isNewerVersion("3.2.1", "3.3.0"))
        assertTrue(AppUpdateManager.isNewerVersion("3.2.0", "3.3.0"))
        assertTrue(AppUpdateManager.isNewerVersion("3.1.1", "3.3.0"))
        assertTrue(AppUpdateManager.isNewerVersion("3.0.0", "3.3.0"))
        assertTrue(AppUpdateManager.isNewerVersion("3.0.0", "v3.3.0"))
        ...
        // Same version
        assertFalse(AppUpdateManager.isNewerVersion("5.0.0", "5.0.0"))
        assertFalse(AppUpdateManager.isNewerVersion("5.0.0", "v5.0.0"))
        assertFalse(AppUpdateManager.isNewerVersion("v5.0.0", "5.0.0"))
        assertFalse(AppUpdateManager.isNewerVersion("4.1.0", "4.1.0"))
        ...
        assertFalse(AppUpdateManager.isNewerVersion("3.3.1", "3.3.1"))
        assertFalse(AppUpdateManager.isNewerVersion("3.3.1", "v3.3.1"))
        assertFalse(AppUpdateManager.isNewerVersion("v3.3.1", "3.3.1"))
        assertFalse(AppUpdateManager.isNewerVersion("3.3.0", "3.3.0"))
        assertFalse(AppUpdateManager.isNewerVersion("3.3.0", "v3.3.0"))
        ...
        assertFalse(AppUpdateManager.isNewerVersion("3.3.0", "3.2.3"))
        assertFalse(AppUpdateManager.isNewerVersion("3.3.0", "3.2.2"))
        assertFalse(AppUpdateManager.isNewerVersion("3.3.0", "3.2.1"))
        assertFalse(AppUpdateManager.isNewerVersion("3.3.0", "3.2.0"))
        assertFalse(AppUpdateManager.isNewerVersion("3.3.0", "3.1.1"))
