...
See the built-in plugins under [`app/src/main/assets/plugins/`](https://github.com/Maheswara660/Packora/tree/main/app/src/main/assets/plugins) and the market packages under [`modules/`](https://github.com/Maheswara660/Packora/tree/main/modules) for complete working examples.
