...
The authoritative submission rules, field schemas, reviewer checklist, and CI validation live in [`modules/README.md`](https://github.com/Maheswara660/Packora/blob/main/modules/README.md). This page is a quick start.
:::
