...
Yes. Packora is 100% free and open source under the [GNU General Public License v3.0 (GPLv3)](https://github.com/Maheswara660/Packora/blob/main/LICENSE).
...
No. The entire build — binary patching, signing, and AAB export — happens on-device. A PC is only needed if you want to build Packora itself from source.

### How is this different from a URL-wrapper app?

A URL wrapper just opens a website in a WebView. Packora additionally runs **real server runtimes on-device** (Node.js, PHP, Python, Go, WordPress via fork+exec), ships a hardened network stack (DoH, TLS fingerprint, ECH), patches and signs APKs at the binary level, and supports modules/userscripts/MV3 extensions — all without a PC or remote build server.
...
- **JS/CSS modules** — Packora's native format with a config UI and panel. See [JS Modules](/extensions/js-module).
...
- GitHub: [github.com/Maheswara660/Packora](https://github.com/Maheswara660/Packora)
- Telegram: [t.me/packora777](https://t.me/packora777)
- X (Twitter): [@Maheswara660](https://github.com/Maheswara660/Packora)
